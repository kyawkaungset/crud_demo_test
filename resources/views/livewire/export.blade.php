<div>
    <a wire:click="export" class="btn btn-outline-primary">
        <button type="button" class="mx-4 mt-4 px-2 py-1focus:outline-none text-white bg-orange-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm  py-1 me-2 mb-2">Livewire Laravel Export Export</button>
    </a>
